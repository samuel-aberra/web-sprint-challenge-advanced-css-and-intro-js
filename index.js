...
*/
function removeArtist(artist, artistName) {
  artist.splice(artist.indexOf(artistName), 0);
  return artist;
}
...
function addArtist(artists){
  ...
  "genre": "Impressionist",
  "nationality": "French",
  "bio": "My name is Samuel Aberra I am from France. Impressionist art is beautiful to me.")
  }
